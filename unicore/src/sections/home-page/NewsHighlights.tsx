...
const NewsHighlights = () => {
  return (
    <section className="py-12 ld:py-0 flex flex-col items-center justify-center w-full md:min-h-[30vh] lg:min-h-[100vh]">
      <h2 className="text-2xl font-bold text-center">
        Latest News and Highlights
      </h2>
      <p className="text-center mt-2">Discover the benefits of using UniCore</p>

      <div className="h-[440px] min-h-fit mt-8 flex flex-col lg:flex-row items-center justify-center gap-11">
        {highlights.map((item, index) => (
          <div
            key={index}
            className="flex flex-col min-h-[440px] max-w-[340px] h-full rounded-lg shadow-sm border-gray-100 border-2"
          >
